...
class TestFields(TestCase):
    MANDATORY_ELEMENTS = [
        (
            '//div[contains(@class, "first_block")]'
            '/div/input[contains(@placeholder, "first name")]'
        ),
        (
            '//div[contains(@class, "first_block")]'
            '/div/input[contains(@placeholder, "last name")]'),
    ...
    def test_mandatory_fields_1(self):
        ...
        elements = []
        for element_xpath in TestFields.MANDATORY_ELEMENTS:
        ...
        # записываем в переменную welcome_text
        #  текст из элемента welcome_text_elt
